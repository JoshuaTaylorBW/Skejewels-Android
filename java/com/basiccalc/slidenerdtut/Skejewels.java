...
public class Skejewels extends AppCompatActivity implements NavigationDrawerFragment.OnFragmentInteractionListener, View.OnClickListener, View.OnTouchListener {
    ...
    private String clickedEventName, clickedEventId;
    ...
    private ArrayList<String> spreadEventNames = new ArrayList<String>();
    private ArrayList<Integer> spreadEventIds = new ArrayList<Integer>();
    ...
    private int exactNumberOfPreferences = 1;
    ...
    private TextView header12;
    private TextView header13;
    private TextView header14;
    private TextView header15;
    private TextView header16;
    private TextView header17;
    private TextView header18;
    private TextView header19;
    private TextView header20;
    private TextView header21;
    private TextView header22;
    private TextView header23;
    private TextView header24;
    private TextView header25;
    private TextView header26;
    private TextView header27;
    private TextView header28;
    private TextView header29;
    private TextView header30;
    private TextView header31;
    private TextView header32;
    private TextView header33;
    private TextView header34;
    private TextView header35;
    private TextView header36;
    private TextView header37;
    private TextView header38;
    private TextView header39;
    private TextView header40;
    private TextView header41;
    private TextView header42;
    ...
    private TextView content27;
    private TextView content28;
    private TextView content29;
    private TextView content30;
    private TextView content31;
    private TextView content32;
    private TextView content33;
    private TextView content34;
    private TextView content35;
    private TextView content36;
    private TextView content37;
    private TextView content38;
    private TextView content39;
    private TextView content40;
    private TextView content41;
    private TextView content42;
    ...
    public void getHeaders() {
        ...
        header6 = (TextView) findViewById(R.id.header6);
        header7 = (TextView) findViewById(R.id.header7);
        header8 = (TextView) findViewById(R.id.header8);
        header9 = (TextView) findViewById(R.id.header9);
        header10 = (TextView) findViewById(R.id.header10);
        header11 = (TextView) findViewById(R.id.header11);
        header12 = (TextView) findViewById(R.id.header12);
        header13 = (TextView) findViewById(R.id.header13);
        header14 = (TextView) findViewById(R.id.header14);
        header15 = (TextView) findViewById(R.id.header15);
        header16 = (TextView) findViewById(R.id.header16);
        header17 = (TextView) findViewById(R.id.header17);
        header18 = (TextView) findViewById(R.id.header18);
        header19 = (TextView) findViewById(R.id.header19);
        header20 = (TextView) findViewById(R.id.header20);
        header21 = (TextView) findViewById(R.id.header21);
        header22 = (TextView) findViewById(R.id.header22);
        header23 = (TextView) findViewById(R.id.header23);
        header24 = (TextView) findViewById(R.id.header24);
        header25 = (TextView) findViewById(R.id.header25);
        header26 = (TextView) findViewById(R.id.header26);
        header27 = (TextView) findViewById(R.id.header27);
        header28 = (TextView) findViewById(R.id.header28);
        header29 = (TextView) findViewById(R.id.header29);
        header30 = (TextView) findViewById(R.id.header30);
        header31 = (TextView) findViewById(R.id.header31);
        header32 = (TextView) findViewById(R.id.header32);
        header33 = (TextView) findViewById(R.id.header33);
        header34 = (TextView) findViewById(R.id.header34);
        header35 = (TextView) findViewById(R.id.header35);
        header36 = (TextView) findViewById(R.id.header36);
        header37 = (TextView) findViewById(R.id.header37);
        header38 = (TextView) findViewById(R.id.header38);
        header39 = (TextView) findViewById(R.id.header39);
        header40 = (TextView) findViewById(R.id.header40);
        header41 = (TextView) findViewById(R.id.header41);
        header42 = (TextView) findViewById(R.id.header42);
    }
    ...
    public void getContents() {
        ...
        content25 = (TextView) findViewById(R.id.content25);
        content26 = (TextView) findViewById(R.id.content26);
        content27 = (TextView) findViewById(R.id.content27);
        content28 = (TextView) findViewById(R.id.content28);
        content29 = (TextView) findViewById(R.id.content29);
        content30 = (TextView) findViewById(R.id.content30);
        content31 = (TextView) findViewById(R.id.content31);
        content32 = (TextView) findViewById(R.id.content32);
        content33 = (TextView) findViewById(R.id.content33);
        content34 = (TextView) findViewById(R.id.content34);
        content35 = (TextView) findViewById(R.id.content35);
        content36 = (TextView) findViewById(R.id.content36);
        content37 = (TextView) findViewById(R.id.content37);
        content38 = (TextView) findViewById(R.id.content38);
        content39 = (TextView) findViewById(R.id.content39);
        content40 = (TextView) findViewById(R.id.content40);
        content41 = (TextView) findViewById(R.id.content41);
        content42 = (TextView) findViewById(R.id.content42);
    ...
    */
                ...
                if (button.getId() == spreadButtonIds.get(i)) {
                    ...
                    if (i % 2 == 0) {
                        if (SystemClock.elapsedRealtime() - mLastClickTime < 100) {
                            clickedEventName = spreadEventNames.get(i);
                            clickedEventId = Integer.toString(spreadEventIds.get(i));
    ...
    public void makeSpreadCard(int cardId, int usersId, String eventName, String usersName, int commentAmount,
        ...
        spreadEventNames.add(eventName);
        spreadEventIds.add(eventId);
    ...
    class getSpread extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String url_select = "http://skejewels.com/Android/MakeAndroidFeed.php?length=" + spreadLength + "&id=" + userId;
            Log.d(TAG, "" + yearInt);
    ...
    class like extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            String newEventName = clickedEventName.replaceAll("\\s+", "JambaSlammerCameraManForNothingEverMattered").replace("&", "and");

            String url_select = "http://skejewels.com/Android/AndroidLike.php?eventId=" + clickedEventId + "&eventName=" + newEventName + "&UserId=" + userId;
    ...
    class unlike extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String url_select = "http://skejewels.com/Android/AndroidUnlike.php?eventId=" + clickedEventId + "&UserId=" + userId;
    ...
    class getUserInfo extends AsyncTask<String, String, Void> {
        ...
        protected void onPostExecute(Void v) {
            try {
                ...
                Log.d("log_tag", FirstNames + " and also " + LastNames + " and also " + Nickname);
                this.progressDialog.dismiss();
            } catch (Exception e) {
                Log.e("log_tag", "Error parsing data " + e.toString());
            }
    ...
    private void setId() {
        ...
        Log.d("soooo", userId + " Is this still here?");
    }
